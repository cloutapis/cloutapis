...
export class PostParser {
    ...
    private getLatestTaggedPosts = async () => {
        ...
        console.log(`Retrieved ${ response?.PostsFound?.length } posts`)
        ...
        response?.PostsFound.forEach(function (post: any) {
            overlappedWithLastRun = overlappedWithLastRun || post.transactionHashHex == hashHexToCheckFor
        ...
        this.lastRunLatestPostHashHex = response?.PostsFound[0].transactionHashHex
        return mappings;
    }
